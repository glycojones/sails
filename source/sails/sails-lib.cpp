...
std::vector<SearchResult> sails::sugar_results ( clipper::Xmap<float>& xwrk, sails::data::build_options& options, double step, int nhit )
{
    ...
    for (int i=0; i < fp_data.size(); i++)
    {
        ...
        temp_result = ssfind.search( all_co, rots, sigcut, 0.0, name_sugar );
...
clipper::MiniMol sails::build_sugars ( std::vector<SearchResult> results, clipper::Xmap<float>& xwrk, sails::data::build_options& options, double step, int nhit ) {
    ...
    for ( int k = 0; k < int(results.size()); k++ ) 
    {
        ...
        if (k == 0)
        {
            ...
            for (int p = 0; p < int(fp_data.size()); p++)
            {
                if (fp_data[p].name_short == name_sugar)
                {
                    ...
                    mprot.operator[](mprot.size() - 1).transform( rtop );  /// THE VALUE OF K IS CAUSING SEGFAULT  
        ...
        else 
        {
            ...
            // if (std::all_of( distance_vector.begin(), distance_vector.end(), [] (int t){return t<0.1;}) ) 
...
// 	{
// 		"NAG", "nglycan", 15,12,12,
// 		{
// { "C1", 2.165, 0, 1.191 }, 
// { "C2", 0.701, 0.462, 1.277 }, 
// { "C3", 0, 0, 0 }, 
// { "C4", 0.741, 0.468, -1.238 }, 
// { "C5", 2.2, 0, -1.211 }, 
// { "C6", 3.049, 0.559, -2.347 }, 
// { "C7", -0.017, 0.629, 3.666 }, 
// { "N2", 0.136, -0.063, 2.517 }, 
// { "O3", -1.355, 0.429, -0.034 }, 
// { "O5", 2.816, 0.461, 0.023 }, 
// { "O7", -0.234, 1.837, 3.656 }, 
// { "ND2", 2.926, 0.551, 2.282 }}, 
// {{ "VD1", -0.25, -3.5, -3 }, 
// { "VD1", -0.75, -2.75, 1.75 }, 
// { "VD1", -3.5, -1.75, 0 }, 
// { "VD1", -3.25, 0.75, -3.25 }, 
...
// { "C6", 3.049, 0.559, -2.347 }, 
// { "C7", -0.017, 0.629, 3.666 }, 
// { "C8", 0.045, -0.131, 4.968 }, 
// { "N2", 0.136, -0.063, 2.517 }, 
// { "O3", -1.355, 0.429, -0.034 }, 
// { "O4", 0.047, -0.073, -2.368 }, 
// { "O5", 2.816, 0.461, 0.023 }, 
// { "O6", 2.868, 1.983, -2.465 }, 
// { "O7", -0.234, 1.837, 3.656 }, 
// { "ND2", 2.926, 0.551, 2.282 }}}, 


	{
		"NAG", "nglycan", 15, 12,15,
		{
{ "C1", 2.165, 0, 1.191 }, 
{ "C2", 0.701, 0.462, 1.277 }, 
{ "C3", 0, 0, 0 }, 
...
// // 		{
// // { "C1", 2.189, -0, 1.216 }, 
// // { "C2", 0.716, 0.427, 1.265 }, 
// // { "C3", 0, 0, 0 }, 
// // { "C4", 0.729, 0.517, -1.22 }, 
// // { "C5", 2.163, -0, -1.201 }, 
// // { "C6", 2.984, 0.472, -2.376 }, 
// // { "C7", -0.582, 0.586, 3.308 }, 
// // { "N2", 0.048, -0.168, 2.415 }, 
// // { "O3", -1.331, 0.52, 0.054 }, 
// // { "O5", 2.788, 0.471, 0.015 }, 
// // { "O7", -0.343, 1.785, 3.41 }, 
// // { "ND2", 2.906, 0.568, 2.338 }}, 
// // {{ "VD1", 1, -2, 0.75 }, 
// // { "VD1", -1.5, -1.75, -0.75 }, 
// // { "VD1", 1.75, 2.75, 0 }, 
// // { "VD1", 2.75, -2, 0 }, 
...
// // { "C6", 2.984, 0.472, -2.376 }, 
// // { "C7", -0.582, 0.586, 3.308 }, 
// // { "C8", -1.473, -0.142, 4.268 }, 
// // { "N2", 0.048, -0.168, 2.415 }, 
// // { "O3", -1.331, 0.52, 0.054 }, 
// // { "O4", 0.062, -0.014, -2.365 }, 
// // { "O5", 2.788, 0.471, 0.015 }, 
// // { "O6", 3.128, 1.875, -2.424 }, 
// // { "O7", -0.343, 1.785, 3.41 }, 
// // { "ND2", 2.906, 0.568, 2.338 } }},

// {
// 		"MAN", "nglycan", 12,10,10,
// 		{
// { "C5", 2.172, 0, -1.192 }, 
// { "C4", 0.736, 0.489, -1.244 }, 
// { "C3", 0, 0, 0 }, 
// { "C2", 0.746, 0.436, 1.247 }, 
// { "C1", 2.198, -0, 1.206 }, 
// { "O5", 2.794, 0.487, -0.012 }, 
// { "O2", 0.698, 1.849, 1.398 }, 
// { "O3", -1.344, 0.489, -0.029 }, 
// { "O4", 0.071, 0.031, -2.433 }, 
// { "O6", 2.12, -1.378, 1.188 }}, 
// {{ "VD1", 0, -2.5, 0.75 }, 
// { "VD1", 0.75, 3, -2 }, 
// { "VD1", 2.5, -2.25, -1.75 }, 
// { "VD1", -0.25, -1.75, 2.25 }, 
// { "VD1", -2.25, 0.25, -2.75 }, 
// { "VD1", 1.75, -8.88178e-16, 3.5 }, 
// { "VD1", -2.25, 2.25, 1.5 }, 
// { "VD1", -1.5, -1.5, -1.25 }, 
// { "VD1", 3.75, 1.5, 2.25 }, 
// { "VD1", -0.5, 0.5, 3.75 }}, 
// {{ "C6", 3.009, 0.538, -2.318 }, 
// { "C5", 2.172, 0, -1.192 }, 
// { "C4", 0.736, 0.489, -1.244 }, 
// { "C3", 0, 0, 0 }, 
// { "C2", 0.746, 0.436, 1.247 }, 
...
// // { "C2", 0.72, 0.55, 1.19 }, 
// // { "C1", 2.096, 0, 1.173 }, 
// // { "O5", 2.802, 0.488, 0.013 }, 
// // { "O3", -1.376, 0.399, -0.02 }, 
// // { "O4", 0.026, -0.19, -2.398 }, 
// // { "O6", 4.218, 0.074, -2.527 }, 
// // { "O4", 2.832, 0.394, 2.298 }}, 
// // {{ "VD1", -2.75, 2.25, -0.5 }, 
// // { "VD1", 1.25, 2, -3.25 }, 
// // { "VD1", 1, -1, 3.25 }, 
// // { "VD1", -0.75, -2.25, -0.5 }, 
...
// // { "VD1", 1.5, -2, -0.25 }, 
// // { "VD1", 0.25, 4.25, 1.25 }}, 
// // {{ "C6", 2.891, 0.584, -2.374 }, 
// // { "C5", 2.158, 0, -1.208 }, 
// // { "C4", 0.685, 0.437, -1.266 }, 
// // { "C3", 0, 0, 0 }, 
// // { "C2", 0.72, 0.55, 1.19 }, 
// // { "C1", 2.096, 0, 1.173 }, 
// // { "O5", 2.802, 0.488, 0.013 }, 
// // { "O2", 0.756, 1.966, 1.157 }, 
// // { "O3", -1.376, 0.399, -0.02 }, 
// // { "O4", 0.026, -0.19, -2.398 }, 
// // { "O6", 4.218, 0.074, -2.527 }, 
// // { "O4", 2.832, 0.394, 2.298 }}},
...
// {
// 		"GAL", "nglycan", 13,11,11,
// 		{
// { "C6", 2.98, 0.382, -2.422 }, 
// { "C5", 2.156, -0, -1.201 }, 
// { "C4", 0.745, 0.621, -1.167 }, 
// { "C3", 0, 0, 0 }, 
// { "C2", 0.731, 0.332, 1.287 }, 
// { "C1", 2.231, -0, 1.243 }, 
// { "O5", 2.877, 0.433, 0.016 }, 
// { "O2", 0.1, -0.384, 2.344 }, 
// { "O3", -1.357, 0.446, 0.139 }, 
// { "O4", 0.843, 2.021, -0.995 }, 
// { "O6", 3.036, 1.79, -2.622 }}, 
// {{ "VD1", -2.25, -0.25, 3 }, 
// { "VD1", -2.5, 1.75, -2 }, 
// { "VD1", -0.75, 2.75, 0.75 }, 
...
// {
// 		"BGC", "nglycan", 13,12,12,
// 		{
// { "C6", 2.992, 0.435, -2.34 }, 
// { "C5", 2.129, 0, -1.178 }, 
// { "C4", 0.731, 0.585, -1.181 }, 
// { "C3", 0, 0, 0 }, 
// { "C2", 0.717, 0.44, 1.241 }, 
// { "C1", 2.161, 0, 1.195 }, 
// { "O5", 2.777, 0.442, 0.011 }, 
// { "O1", 2.887, 0.612, 2.173 }, 
// { "O2", 0.176, -0.104, 2.438 }, 
// { "O3", -1.367, 0.435, -0.054 }, 
// { "O4", 0.085, 0.248, -2.389 }, 
// { "O1", 2.887, 0.612, 2.173 }}, 
// {{ "VD1", 3.75, -1.75, -0.75 }, 
// { "VD1", 0.25, 2.75, 2 }, 
// { "VD1", -0.5, 2.5, -1.75 }, 
...
// {
// 		"FUC", "nglycan", 11,10,10,
// 		{
// { "C6", 3.037, -0.485, -2.366 }, 
// { "C5", 2.199, 0, -1.204 }, 
// { "C4", 0.74, -0.45, -1.264 }, 
// { "C3", 0, 0, 0 }, 
// { "C2", 0.746, -0.453, 1.252 }, 
// { "C1", 2.186, 0, 1.197 }, 
// { "O5", 2.81, -0.506, 0.009 }, 
// { "O2", 0.153, 0.031, 2.454 }, 
// { "O3", -1.338, -0.507, 0.005 }, 
// { "O3", 2.08, 1.424, 1.479 }}, 
// {{ "VD1", 0.75, 1.5, -2.5 }, 
// { "VD1", -1, 1, -2.25 }, 
// { "VD1", 1.25, 0, -3.75 }, 
// { "VD1", 2, -2.25, 2.25 }, 
// { "VD1", 8.88178e-16, 2.25, -0.75 }, 
// { "VD1", -3.25, -1.75, 0.5 }, 
// { "VD1", -1.5, 3.25, 1.25 }, 
// { "VD1", -1.75, -2.25, -1.5 }, 
// { "VD1", 4.25, 1.5, -0.25 }, 
// { "VD1", 8.88178e-16, -2.5, 2.25 }}, 
// {{ "C6", 3.037, -0.485, -2.366 }, 
// { "C5", 2.199, 0, -1.204 }, 
// { "C4", 0.74, -0.45, -1.264 }, 
// { "C3", 0, 0, 0 }, 
...
// { "O2", 0.153, 0.031, 2.454 }, 
// { "O3", -1.338, -0.507, 0.005 }, 
// { "O4", 0.675, -1.873, -1.404 }, 
// { "O3", 2.08, 1.424, 1.479 }}}//, 

// // {
// // 		"FUL", "nglycan", 12,9,9,
// // 		{
// // { "C4", 0.703, -0.433, -1.255 }, 
// // { "C3", 0, 0, 0 }, 
// // { "C1", 2.121, 0, 1.178 }, 
// // { "O5", 2.814, -0.464, 0.016 }, 
// // { "O1", 2.821, -0.437, 2.303 }, 
// // { "O2", -0.014, -0.307, 2.4 }, 
// // { "O3", -1.386, -0.385, -0.022 }, 
// // { "O4", 0.598, -1.867, -1.399 }, 
// // { "O1", 2.821, -0.437, 2.303 }}, 
// // {{ "VD1", -3.5, -1, 0.75 }, 
// // { "VD1", -1.75, -1, 3.75 }, 
// // { "VD1", -1.5, -2, 1.75 }, 
...
// // { "VD1", -1.5, 2.75, -1.75 }, 
// // { "VD1", 0.5, 0.75, -3.25 }}, 
// // {{ "C6", 3.026, -0.484, -2.337 }, 
// // { "C5", 2.166, 0, -1.203 }, 
// // { "C4", 0.703, -0.433, -1.255 }, 
// // { "C3", 0, 0, 0 }, 
// // { "C2", 0.699, -0.588, 1.176 }, 
// // { "C1", 2.121, 0, 1.178 }, 
// // { "O5", 2.814, -0.464, 0.016 }, 
// // { "O1", 2.821, -0.437, 2.303 }, 
// // { "O2", -0.014, -0.307, 2.4 }, 
